...
export function ChatInterface() {
    const [messages, setMessages] = useState<{ role: 'ai' | 'user'; text: string }[]>([
        { role: 'ai', text: 'Hello! I am the MetaCall assistant. How can I help you with your deployments today?' }
    ]);
    ...
    const handleSend = () => {
        ...
        // Mock AI response
        setTimeout(() => {
            setMessages(prev => [...prev, { role: 'ai', text: 'I am a simulated assistant. This feature is currently under development.' }]);
        }, 1000);
    };
            ...
            <div className="w-full max-w-4xl mt-4 flex flex-col h-[calc(100vh-140px)]">
                <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-200">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 font-medium">Talk to our AI assistant or support team</p>
                    </div>
                </div>
