    ...
    return (
        <div
            ...
            className={clsx(
                ...
                dragging ? 'bg-[color-mix(in_srgb,var(--color-primary)_5%,white)]' : 'bg-[--color-elevated] hover:bg-gray-100',
            )}
        >
            <input
                ref={inputRef}
            ...
            {file ? (
                ...
                <div className="flex flex-col items-center gap-3 text-center pointer-events-none transition-transform duration-200 group-hover:scale-105">
                    ...
                    <p className="text-base font-semibold text-[--color-text-primary]">Drag & drop your .zip file here</p>
