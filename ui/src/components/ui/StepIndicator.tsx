                        ...
                        <li key={step.label} className="relative flex flex-col items-center gap-2 w-full">
                            ...
                            <div
                                className={clsx(
                                    ...
                                    !isActive && !isDone && 'bg-white border-2 border-gray-200 text-[--color-text-muted]',
                                )}
                            >
                                {isDone ? <Check size={16} strokeWidth={3} /> : <span className="text-sm">{index + 1}</span>}
                            </div>
                            ...
                            <span
                                className={clsx(
                                    'text-sm font-medium',
                                    (isActive || isDone) ? 'font-bold text-[--color-primary]' : 'text-[--color-text-muted]',
                                )}
                            >
                                {step.label}
                            </span>
